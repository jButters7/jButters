    ...
    <section className='about-container' id='about'>
      ...
      <div className='paragraph-and-icon'>
        <div className='about-paragraph'>
          ...
          <p>In my free time I hike with my wife, play chess, and spend time with my four kids.</p>
        </div>
        <a href='https://docs.google.com/document/d/1kFXUj6DV2Syv6kkm7Q2VbvLHAg0V4fXOsAibcVlxkZ0/edit?usp=sharing' className='computer-resume'>
